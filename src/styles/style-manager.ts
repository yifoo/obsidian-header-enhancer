...
export class StyleManager {
	...
	applyHeaderFontStyles(): void {
		const hasHeaderFontFamily = Boolean(this.settings.isSeparateHeaderFont &&
			this.settings.headerFontFamily &&
			this.settings.headerFontFamily !== "inherit");
		const hasHeaderFontSize = Boolean(this.settings.isSeparateHeaderFont &&
	...
	applyTitleFontStyles(): void {
		const hasTitleFontFamily = Boolean(this.settings.isSeparateTitleFont &&
			this.settings.titleFontFamily &&
			this.settings.titleFontFamily !== "inherit");
		const hasTitleFontSize = Boolean(this.settings.isSeparateTitleFont &&
